...
public class TyokohdeDataAccessService implements TyokohdeDao {

    @Autowired
    private final JdbcTemplate jdbcTemplate;

    @Autowired
    public TyokohdeDataAccessService(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    @Override
    public int insertTyokohde(Tyokohde kohde) {
    ...
    @Override
    public List<Tyokohde> selectAllTyokohde() {
    ...
    @Override
    public Optional<Tyokohde> selectTyokohdeById(Integer id) {
    ...
    @Override
    public int deleteTyokohdeById(Integer id) {
        final String sql = "DELETE FROM tyokohde WHERE kohdeID = ?";
        return jdbcTemplate.update(sql, new Object[]{id});
    }

    @Override
    public int updateTyokohdeById(Integer id, Tyokohde kohde) {
        Integer omistajaID = kohde.getOmistajaID();
        String tyyppi = kohde.getKohdetyyppi();
        String osoite = kohde.getOsoite();
